...
public static class ItemSystem
{
    ...
    public static string GetItemSocketDescription(SocketModel socket)
    {
        ...
        if (socket != null)
        {
            descriptions.Append(socket.vAtk > 0 ? string.Format(Languages.lang[700], socket.vAtk) + "\n" : "");
            descriptions.Append(socket.vMagic > 0 ? string.Format(Languages.lang[701], socket.vMagic) + "\n" : "");
            descriptions.Append(socket.vHealth > 0 ? string.Format(Languages.lang[702], socket.vHealth) + "\n" : "");
            descriptions.Append(socket.vMana > 0 ? string.Format(Languages.lang[703], socket.vMana) + "\n" : "");
            descriptions.Append(socket.vArmor > 0 ? string.Format(Languages.lang[704], socket.vArmor) + "\n" : "");
            descriptions.Append(socket.vMagicResist > 0 ? string.Format(Languages.lang[705], socket.vMagicResist) + "\n" : "");
            descriptions.Append(socket.vHealthRegen > 0 ? string.Format(Languages.lang[706], socket.vHealthRegen) + "\n" : "");
            descriptions.Append(socket.vManaRegen > 0 ? string.Format(Languages.lang[707], socket.vManaRegen) + "\n" : "");
            descriptions.Append(socket.vDamageEarth > 0 ? string.Format(Languages.lang[708], socket.vDamageEarth) + "\n" : "");
            descriptions.Append(socket.vDamageWater > 0 ? string.Format(Languages.lang[709], socket.vDamageWater) + "\n" : "");
            descriptions.Append(socket.vDamageFire > 0 ? string.Format(Languages.lang[710], socket.vDamageFire) + "\n" : "");
            descriptions.Append(socket.vDefenseEarth > 0 ? string.Format(Languages.lang[711], socket.vDefenseWater) + "\n" : "");
            descriptions.Append(socket.vDefenseWater > 0 ? string.Format(Languages.lang[712], socket.vDefenseWater) + "\n" : "");
            descriptions.Append(socket.vDefenseFire > 0 ? string.Format(Languages.lang[713], socket.vDefenseFire) + "\n" : "");
            descriptions.Append(socket.vAtkSpeed > 0 ? string.Format(Languages.lang[714], socket.vAtkSpeed) + "\n" : "");
            descriptions.Append(socket.vLifeStealPhysic > 0 ? string.Format(Languages.lang[715], socket.vLifeStealPhysic) + "\n" : "");
            descriptions.Append(socket.vLifeStealMagic > 0 ? string.Format(Languages.lang[716], socket.vLifeStealMagic) + "\n" : "");
            descriptions.Append(socket.vLethality > 0 ? string.Format(Languages.lang[717], socket.vLethality) + "\n" : "");
            descriptions.Append(socket.vMagicPenetration > 0 ? string.Format(Languages.lang[718], socket.vMagicPenetration) + "\n" : "");
            descriptions.Append(socket.vCritical > 0 ? string.Format(Languages.lang[719], socket.vCritical) + "\n" : "");
            descriptions.Append(socket.vTenacity > 0 ? string.Format(Languages.lang[720], socket.vTenacity) + "\n" : "");
            descriptions.Append(socket.vCooldownReduction > 0 ? string.Format(Languages.lang[721], socket.vCooldownReduction) + "\n" : "");
            descriptions.Append(socket.vAtkPlus > 0 ? string.Format(Languages.lang[722], socket.vAtkPlus) + "\n" : "");
            descriptions.Append(socket.vMagicPlus > 0 ? string.Format(Languages.lang[723], socket.vMagicPlus) + "\n" : "");
            descriptions.Append(socket.vHealthPlus > 0 ? string.Format(Languages.lang[724], socket.vHealthPlus) + "\n" : "");
            descriptions.Append(socket.vManaPlus > 0 ? string.Format(Languages.lang[725], socket.vManaPlus) + "\n" : "");
            descriptions.Append(socket.vArmorPlus > 0 ? string.Format(Languages.lang[734], socket.vArmorPlus) + "\n" : "");
            descriptions.Append(socket.vMagicResistPlus > 0 ? string.Format(Languages.lang[735], socket.vMagicResistPlus) + "\n" : "");
            descriptions.Append(socket.vDamageExcellent > 0 ? string.Format(Languages.lang[726], socket.vDamageExcellent) + "\n" : "");
            descriptions.Append(socket.vDefenseExcellent > 0 ? string.Format(Languages.lang[727], socket.vDefenseExcellent) + "\n" : "");
            descriptions.Append(socket.vDoubleDamage > 0 ? string.Format(Languages.lang[728], socket.vDoubleDamage) + "\n" : "");
            descriptions.Append(socket.vTripleDamage > 0 ? string.Format(Languages.lang[729], socket.vTripleDamage) + "\n" : "");
            descriptions.Append(socket.vDamageReflect > 0 ? string.Format(Languages.lang[730], socket.vDamageReflect) + "\n" : "");
            descriptions.Append(socket.vRewardPlus > 0 ? string.Format(Languages.lang[731], socket.vRewardPlus) + "\n" : "");
        }
    ...
    public static string GetItemDescription(sbyte itemType, byte itemID)
    {
        ...
        {
            case 10:
                return result.Append(Languages.ItemInforType10[itemID]).Append(ItemSystem.GetRegionItemDrop(itemType, itemID)).ToString();
            //return Languages.ItemInforType10[itemID] + ItemSystem.GetRegionItemDrop (itemType, itemID);
            case 11:
                return result.Append(Languages.ItemInforType11[itemID]).Append(GetCraftedItem(itemType, itemID)).Append(ItemSystem.GetRegionItemDrop(itemType, itemID)).ToString();
            //return Languages.ItemInforType11[itemID] + GetCraftedItem (itemType, itemID) + ItemSystem.GetRegionItemDrop (itemType, itemID);
            case 12:
                return result.Append(Languages.ItemInforType12[itemID]).Append(ItemSystem.GetRegionItemDrop(itemType, itemID)).ToString();
    ...
    public static string GetItemDescription(ItemModel item)
    {
        ...
        if (item.ItemTypeMode.Equals(global::ItemModel.TypeMode.Equip))
        {
            descriptions.Append(item.vAtk > 0 ? string.Format(Languages.lang[700] +
            ...
            descriptions.Append(item.vMagic > 0 ? string.Format(Languages.lang[701] +
            ...
            descriptions.Append(item.vHealth > 0 ? string.Format(Languages.lang[702] +
            ...
            descriptions.Append(item.vMana > 0 ? string.Format(Languages.lang[703] +
            ...
            descriptions.Append(item.vArmor > 0 ? string.Format(Languages.lang[704] +
            ...
            descriptions.Append(item.vMagicResist > 0 ? string.Format(Languages.lang[705] +
            ...
            descriptions.Append(item.vHealthRegen > 0 ? string.Format(Languages.lang[706] +
            ...
            descriptions.Append(item.vManaRegen > 0 ? string.Format(Languages.lang[707] +
            ...
            descriptions.Append(item.vDamageEarth > 0 ? string.Format(Languages.lang[708], String.Format("{0:0.#}", item.vDamageEarth)) + "\n" : "");
            descriptions.Append(item.vDamageWater > 0 ? string.Format(Languages.lang[709], String.Format("{0:0.#}", item.vDamageWater)) + "\n" : "");
            descriptions.Append(item.vDamageFire > 0 ? string.Format(Languages.lang[710], String.Format("{0:0.#}", item.vDamageFire)) + "\n" : "");
            descriptions.Append(item.vDefenseEarth > 0 ? string.Format(Languages.lang[711], String.Format("{0:0.#}", item.vDefenseEarth)) + "\n" : "");
            descriptions.Append(item.vDefenseWater > 0 ? string.Format(Languages.lang[712], String.Format("{0:0.#}", item.vDefenseWater)) + "\n" : "");
            descriptions.Append(item.vDefenseFire > 0 ? string.Format(Languages.lang[713], String.Format("{0:0.#}", item.vDefenseFire)) + "\n" : "");
            descriptions.Append(item.vAtkSpeed > 0 ? string.Format(Languages.lang[714], item.vAtkSpeed) + "\n" : "");
            descriptions.Append(item.vLifeStealPhysic > 0 ? string.Format(Languages.lang[715], item.vLifeStealPhysic) + "\n" : "");
            descriptions.Append(item.vLifeStealMagic > 0 ? string.Format(Languages.lang[716], item.vLifeStealMagic) + "\n" : "");
            descriptions.Append(item.vLethality > 0 ? string.Format(Languages.lang[717], item.vLethality) + "\n" : "");
            descriptions.Append(item.vMagicPenetration > 0 ? string.Format(Languages.lang[718], item.vMagicPenetration) + "\n" : "");
            descriptions.Append(item.vCritical > 0 ? string.Format(Languages.lang[719], item.vCritical) + "\n" : "");
            descriptions.Append(item.vTenacity > 0 ? string.Format(Languages.lang[720], item.vTenacity) + "\n" : "");
            descriptions.Append(item.vCooldownReduction > 0 ? string.Format(Languages.lang[721], item.vCooldownReduction) + "\n" : "");
            descriptions.Append(item.vAtkPlus > 0 ? string.Format(Languages.lang[722], item.vAtkPlus) + "\n" : "");
            descriptions.Append(item.vMagicPlus > 0 ? string.Format(Languages.lang[723], item.vMagicPlus) + "\n" : "");
            descriptions.Append(item.vHealthPlus > 0 ? string.Format(Languages.lang[724], item.vHealthPlus) + "\n" : "");
            descriptions.Append(item.vManaPlus > 0 ? string.Format(Languages.lang[725], item.vManaPlus) + "\n" : "");
            descriptions.Append(item.vArmorPlus > 0 ? string.Format(Languages.lang[734], item.vArmorPlus) + "\n" : "");
            descriptions.Append(item.vMagicResistPlus > 0 ? string.Format(Languages.lang[735], item.vMagicResistPlus) + "\n" : "");
            descriptions.Append(item.vDamageExcellent > 0 ? string.Format(Languages.lang[726], item.vDamageExcellent) + "\n" : "");
            descriptions.Append(item.vDefenseExcellent > 0 ? string.Format(Languages.lang[727], item.vDefenseExcellent) + "\n" : "");
            descriptions.Append(item.vDoubleDamage > 0 ? string.Format(Languages.lang[728], item.vDoubleDamage) + "\n" : "");
            descriptions.Append(item.vTripleDamage > 0 ? string.Format(Languages.lang[729], item.vTripleDamage) + "\n" : "");
            descriptions.Append(item.vDamageReflect > 0 ? string.Format(Languages.lang[730], item.vDamageReflect) + "\n" : "");
            descriptions.Append(item.vRewardPlus > 0 ? string.Format(Languages.lang[731], item.vRewardPlus) + "\n" : "");
            descriptions.Append(item.vSocketSlot > 0 ? string.Format(Languages.lang[732], item.vSocketSlot) + "\n" : "");
            //Thông tin socket
                ...
                if (item.Sockets != null)
                {
                    for (sbyte i = 0; i < item.vSocketSlot; i++)
                    {
                        if (item.Sockets.Count > i)
                            descriptions.Append("     " + ItemSystem.GetItemSocketDescription(item.Sockets[i]));
                        else
                            descriptions.Append("     " + Languages.lang[733]).Append("\n");
                    }
                }
                else
                {
        ...
        else
        {
            ...
            {
                case 10:
                    descriptions.Append(Languages.ItemInforType10[item.ItemID]).Append(ItemSystem.GetRegionItemDrop(item.ItemType, item.ItemID));
                    break;
                case 11:
                    descriptions.Append(Languages.ItemInforType11[item.ItemID]).Append(GetCraftedItem(item.ItemType, item.ItemID)).Append(ItemSystem.GetRegionItemDrop(item.ItemType, item.ItemID));
                    break;
                case 12:
                    descriptions.Append(Languages.ItemInforType12[item.ItemID]).Append(ItemSystem.GetRegionItemDrop(item.ItemType, item.ItemID));
                    break;
                default:
                    break;
            }
    ...
    public static string GetRegionItemDrop(sbyte itemType, byte itemID)
    {
        ...
        {
            result.Append(Languages.lang[260]);
            var count = listItemDrop.Count;
            for (sbyte i = 0; i < count; i++)
            {
                result.Append(Languages.lang[listItemDrop[i].DropOnMap + 168]).Append("(").Append(listItemDrop[i].Ratio / 100f).Append("%)").Append((i != count - 1 ? ", " : ""));
            }
            return result.ToString();
        }
        else
